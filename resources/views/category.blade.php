                        ...
                        <form action="{{ route('category') }}" method="GET">
                            <div class="price-range-container">
                                <div class="current-range mb-3">
                                    ...
                                    <span class="max-price float-end">Rp 10000000</span>
                                </div>
                                    ...
                                    <div class="col-12" data-aos="fade-up" data-aos-delay="200">
                                        <div class="active-filters">
                                            ...
                                            <div class="filter-tags">
                                                ...
                                                @endforeach
                                                <a href="{{ route('category') }}" class="clear-all-btn">Clear All</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-xl-4">
                                    <div class="product-card" data-aos="zoom-in">
                                        <div class="product-image">
                                            <img src="{{ asset('storage/' . $product->image) }}" class="main-image img-fluid"
                                                alt="Product">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h4 class="product-title"><a href="product-details.html">{{ $product->name }}</a>
                                            </h4>
